...
<main class="container">
    ...
    <div class="row g-5">
        <div class="col-md-8">
            ...
            <div>
                <h2 class="blog-post-title">Форма заказа на получение выгрузки</h2>
            ...
            <div>
                <h2 class="blog-post-title">Форма для получения данных от пользователя</h2>
                <form method="get" action="{{route('home.store')}}">
                    @csrf
                    <div class="form-group">
